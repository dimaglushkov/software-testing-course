...
public class QuestionsPage extends HomePage {
    ...
    final static String answerQuestionButtonXPath = "/html/body/div[1]/div/div/div[1]/div[2]/div[1]/div[2]/div[1]/div/div[1]/div[3]/div/button";
    final static String answerTextFieldXPath = "/html/body/div[3]/div[3]/div/div/div[2]/div[1]/div[1]/div[2]/div";
    ...
    public boolean answerQuestion(String questionUrl, String text) {
        WebElement editor = getOnlineEditor(questionUrl);
    ...
    public WebElement getOnlineEditor(String questionUrl){
        webDriver.get(questionUrl);
        ...
        WebElement editor = webDriver.findElement(By.xpath(answerTextFieldXPath));
        editor.click();
        return editor;
    }
